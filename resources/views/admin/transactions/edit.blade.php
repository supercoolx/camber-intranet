...
<form method="POST" action="{{ route('transactions.update', ['agent'=>$user->id]) }}"
    ...
    <div class="col-sm-6"><a href="{{ url('admin/transactions') }}" class="btn form-control btn-light">Cancel</a></div>
    </div>
</form>
